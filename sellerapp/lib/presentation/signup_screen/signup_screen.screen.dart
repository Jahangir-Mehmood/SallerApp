    ...
    return bgWidget(Scaffold(
        ...
        body: Center(
          ...
          Column(children: [
            ...
            Align(alignment: Alignment.topRight, child: TextButton(onPressed: () {}, child: forgetPasswowd.text.make())),
            Row(children: [
              Obx(() {
                return Checkbox(
              ...
              return ourButton(
                  ...
                  onPress: () async {
                    if (controller.isChecked != false) {
                      try {
                        await controller.signupMethod(context: context, email: controller.email.text, password: controller.password.text).then((value) {
